    ...
    def __init__(self):
        ...
        try:
            ...
            if redis_url and redis_url.startswith("redis://"):
                ...
                logger.info("redis_client_initialized", url=redis_url, version="5.2.1+")
            else:
                logger.warning("redis_url_not_configured", message="Redis URL not configured. Using no-op cache.")
